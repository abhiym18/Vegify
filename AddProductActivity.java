...
public class AddProductActivity  extends AppCompatActivity {
    ...
    private void SaveProductInfoToDatabase()
    {
       ...
       Product_ID=fauth.getCurrentUser().getUid();
       //Item_ID=fauth.getUid();



       ProductsRef.collection("productMap").document(Product_ID).collection("productfields").document().set(productMap)
